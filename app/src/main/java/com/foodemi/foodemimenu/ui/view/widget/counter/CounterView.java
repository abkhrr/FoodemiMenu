package com.foodemi.foodemimenu.ui.view.widget.counter;
...
public class CounterView extends LinearLayout implements View.OnClickListener{
    ...
    private void checkFabColor(){
        if(mCounterValue > 0){
            mBtnDecrease.setBackgroundTintList(ColorStateList.valueOf(ContextCompat.getColor(mContext , R.color.FOODEMI_DEFAULT_BACKGROUND)));
        }else{
